...
- New `fontsizeinput` button added to the toolbar which allows the user to set the size via input and also increase and decrease it with `+` and `-` buttons. #TINY-9429
